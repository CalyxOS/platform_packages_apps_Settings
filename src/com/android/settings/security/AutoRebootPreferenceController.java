...
public class AutoRebootPreferenceController extends AbstractPreferenceController
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (KEY_AUTO_REBOOT.equals(key) && value instanceof String && mIsAdmin) {
            ...
            Settings.Global.putInt(mContext.getContentResolver(), Settings.Global.DEVICE_REBOOT_TIMEOUT, hoursToMilli(timeout));
        }
        return true;
    }

    private String currentValueInHours() {
        int value = Settings.Global.getInt(mContext.getContentResolver(), Settings.Global.DEVICE_REBOOT_TIMEOUT, 0);
