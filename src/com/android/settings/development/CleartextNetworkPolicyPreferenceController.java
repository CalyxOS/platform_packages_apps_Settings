...
public class CleartextNetworkPolicyPreferenceController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return LineageSettings.Global.getInt(mContext.getContentResolver(),
                LineageSettings.Global.CLEARTEXT_NETWORK_POLICY, StrictMode.NETWORK_POLICY_ACCEPT)
    ...
    public boolean setChecked(boolean isChecked) {
        return LineageSettings.Global.putInt(mContext.getContentResolver(),
                ...
                isChecked ? StrictMode.NETWORK_POLICY_REJECT : StrictMode.NETWORK_POLICY_ACCEPT);
    }
}