    ...
    public int getAvailabilityStatus() {
        ...
        if (network != null) {
            ...
            if (linkProperties != null) {
                return linkProperties.isPrivateDnsActive() ? AVAILABLE
                        : DISABLED_DEPENDENT_SETTING;
            }
        }
        return isChecked() ? AVAILABLE : DISABLED_DEPENDENT_SETTING;
    }

    @Override
    public boolean isChecked() {
        return LineageSettings.Global.getInt(mContext.getContentResolver(),
                LineageSettings.Global.CLEARTEXT_NETWORK_POLICY, StrictMode.NETWORK_POLICY_INVALID)
                != StrictMode.NETWORK_POLICY_INVALID;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return LineageSettings.Global.putInt(mContext.getContentResolver(),
