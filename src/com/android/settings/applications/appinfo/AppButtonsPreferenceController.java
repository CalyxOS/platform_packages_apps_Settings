...
public class AppButtonsPreferenceController extends BasePreferenceController implements
    ...
    private class HideAppDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            String positiveBTString = getString(hidden ? R.string.unhide_app : R.string.hide_app);
    ...
    private void initButtonPreference() {
        mButtonsPref = ((ActionButtonsPreference) mScreen.findPreference(
                ...
                .setButton4OnClickListener(v -> {
                    String HIDE_APP_DIALOG_FRAG_TAG = "HideAppDialogFragment";
                    new HideAppDialogFragment().show(
                        mFragment.getChildFragmentManager(),
                        HIDE_APP_DIALOG_FRAG_TAG
                    );
                });
    }
