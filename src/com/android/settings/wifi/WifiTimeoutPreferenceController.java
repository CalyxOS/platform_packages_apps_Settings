...
public class WifiTimeoutPreferenceController extends BasePreferenceController implements
    ...
    public void updateState(Preference preference) {
        ...
        final long currentTimeout = LineageSettings.Global.getLong(mContext.getContentResolver(),
                LineageSettings.Global.WIFI_OFF_TIMEOUT, FALLBACK_WIFI_TIMEOUT_VALUE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        try {
            ...
            LineageSettings.Global.putInt(mContext.getContentResolver(), LineageSettings.Global.WIFI_OFF_TIMEOUT, value);
