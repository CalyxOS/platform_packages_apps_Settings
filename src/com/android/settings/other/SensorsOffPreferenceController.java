...
public class SensorsOffPreferenceController extends TogglePreferenceController {
    ...
    private static final String COMPONENT_NAME = ".development.qstile.DevelopmentTiles$SensorsOff";
    ...
    public SensorsOffPreferenceController(Context context, String preferenceKey) {
        ...
        mComponentName = new ComponentName(PACKAGE_NAME, PACKAGE_NAME + COMPONENT_NAME);
    ...
    public boolean isChecked() {
        final int enabledSetting = mPackageManager.getComponentEnabledSetting(mComponentName);
