...
public class UserDetailsSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_USER_TIMEOUT_TIME = "user_timeout_time";

    private static final String INTENT_TIMEOUT = "android.intent.action.USER_TIMEOUT";
    ...
    private static final int DIALOG_USER_TIMEOUT = 5;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPhonePref) {
            ...
            if (Boolean.TRUE.equals(newValue)) {
                ...
                Settings.Secure.putLongForUser(getActivity().getContentResolver(),
                        Settings.Secure.USER_ACTIVITY_END_TIME, -1, mUserInfo.id);
            ...
            case DIALOG_USER_TIMEOUT:
                ...
                timePickerDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        mUserTimeoutPref.setChecked(false);
                    }
                });
