...
public final class Enable3gPreferenceControllerTest {
    ...
    private Enable3gPreferenceController mController;
    ...
    public void setUp() {
        ...
        mController = new Enable3gPreferenceController(mContext, "mobile_data");
    ...
    public void onPreferenceChange_update() {
        // Set "Enable 3G" flag to "on"
        when(mTelephonyManager.getAllowedNetworkTypesForReason(
                TelephonyManager.ALLOWED_NETWORK_TYPES_REASON_ENABLE_3G)).thenReturn(
        ...
        doReturn(true).when(mTelephonyManager).isRadioInterfaceCapabilitySupported(
                mTelephonyManager.CAPABILITY_USES_ALLOWED_NETWORK_TYPES_BITMASK);
        mPersistableBundle.putBoolean(CarrierConfigManager.KEY_HIDE_ENABLE_3G,
                false);
        ...
        verify(mTelephonyManager, times(1)).setAllowedNetworkTypesForReason(
                TelephonyManager.ALLOWED_NETWORK_TYPES_REASON_ENABLE_3G,
                TelephonyManager.NETWORK_TYPE_BITMASK_LTE);
    }
}
